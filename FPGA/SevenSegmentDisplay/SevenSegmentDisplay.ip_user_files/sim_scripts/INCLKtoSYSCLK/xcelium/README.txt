...
#
# Generated by export_simulation on Sat Apr 29 11:28:47 -0500 2023
#
################################################################################
...
'-reset_run' switch to the './INCLKtoSYSCLK.sh' script.

./INCLKtoSYSCLK.sh -reset_run
...
./INCLKtoSYSCLK.sh -noclean_files

For more information on the script, please type './INCLKtoSYSCLK.sh -help'.
