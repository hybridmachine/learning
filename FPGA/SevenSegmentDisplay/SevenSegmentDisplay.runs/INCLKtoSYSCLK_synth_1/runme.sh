...
HD_PWD='C:/Users/brian/source/repos/hybridmachine/learning/FPGA/SevenSegmentDisplay/SevenSegmentDisplay.runs/INCLKtoSYSCLK_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log INCLKtoSYSCLK.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source INCLKtoSYSCLK.tcl
