...
HD_PWD='C:/Users/brian/source/repos/hybridmachine/learning/FPGA/SevenSegmentDisplay/SevenSegmentDisplay.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SW7SegDisplayDriver.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SW7SegDisplayDriver.tcl
