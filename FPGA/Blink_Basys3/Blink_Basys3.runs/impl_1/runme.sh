...
HD_PWD='C:/Users/brian/source/repos/hybridmachine/learning/FPGA/Blink_Basys3/Blink_Basys3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BlinkLEDs.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BlinkLEDs.tcl -notrace
