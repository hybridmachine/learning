...
HD_PWD='C:/Users/brian/source/repos/hybridmachine/learning/FPGA/Blink_Basys3/Blink_Basys3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BlinkLEDs.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BlinkLEDs.tcl
