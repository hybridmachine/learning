...
HD_PWD='C:/Users/brian/source/repos/hybridmachine/learning/FPGA/Thermostat/Thermostat.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Thermostat.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Thermostat.tcl -notrace
