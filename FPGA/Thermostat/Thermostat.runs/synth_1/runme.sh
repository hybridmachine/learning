...
HD_PWD='C:/Users/brian/source/repos/hybridmachine/learning/FPGA/Thermostat/Thermostat.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Thermostat.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Thermostat.tcl
