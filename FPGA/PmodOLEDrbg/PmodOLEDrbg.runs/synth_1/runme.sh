...
HD_PWD='C:/Users/brian/source/repos/hybridmachine/learning/FPGA/PmodOLEDrbg/PmodOLEDrbg.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ResetScreen.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ResetScreen.tcl
