...
HD_PWD='C:/Users/brian/source/repos/hybridmachine/learning/FPGA/PmodOLEDrbg/PmodOLEDrbg.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ResetScreen.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ResetScreen.tcl -notrace
