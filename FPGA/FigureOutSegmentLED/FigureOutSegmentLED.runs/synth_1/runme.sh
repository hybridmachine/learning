...
HD_PWD='C:/Users/brian/source/repos/hybridmachine/learning/FPGA/FigureOutSegmentLED/FigureOutSegmentLED.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ManualControl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ManualControl.tcl
