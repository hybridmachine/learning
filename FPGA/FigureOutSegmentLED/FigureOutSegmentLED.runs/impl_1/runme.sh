...
HD_PWD='C:/Users/brian/source/repos/hybridmachine/learning/FPGA/FigureOutSegmentLED/FigureOutSegmentLED.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ManualControl.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ManualControl.tcl -notrace
