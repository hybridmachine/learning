...
HD_PWD='C:/Users/brian/source/repos/hybridmachine/learning/FPGA/VHDL_LabAssignment1/VHDL_LabAssignment1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SeventBitChipSelect.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SeventBitChipSelect.tcl
